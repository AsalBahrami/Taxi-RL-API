"""
Django settings for API_For_Unity project.
...
SECRET_KEY = 'django-insecure-!jko!4s+j3&5t3ld!&x62m4+y#86guqvu+k(ty&xd4d+wrg71l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# TODO: REMOVE AFTER TESTING(added for broken pipe error)
if os.getcwd() == '/app':
    DEBUG = False
